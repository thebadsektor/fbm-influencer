...
export const campaignCreateSchema = z.object({
  ...
  targetAudienceAge: z.string().default("25-34 (Millennials)"),
  targetLocation: z.array(z.string()).default(["US"]),
  ...
  targetKeywords: z.number().int().min(1).max(50).default(10),
  targetHashtags: z.number().int().min(1).max(50).default(10),
  targetLeads: z.number().int().min(100).max(50000).default(2000),
